...
const ProjectSteps = () => (
  <div className="project-steps">
    ...
    <Wizard defaultStep={1}>
      ...
      <WizardStep step={2} title="Build A Custom Team" icon={<WandIcon color="#276cf2" />}>
        <div className="steps-content">
      ...
      <WizardStep step={3} title="Hire The Perfect Fit" icon={<ThumbsupIcon color="#276cf2" />}>
        <div className="steps-content">
      ...
      <WizardStep step={4} title="Ramp Up or Down" icon={<RocketIcon color="#276cf2" />}>
        <div className="steps-content">
