...
const Intro = () => (
  <div className="intro-section">
    <div className="intro-content">
      ...
      <Typography variant="h5" color="secondary" align="left">Discover why leading companies trust our talent network with their most complex implementations.</Typography>
